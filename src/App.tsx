    ...
    <ReactLenis root>
      ...
      <div style={{ visibility: isLoading ? "hidden" : "visible" }}>
        ...
        >
          ...
          >
            <motion.h1
              className="uppercase md:text-[65px] max-sm:text-[10vw] sm:text-[10vw] max-sm:max-w-sm max-sm:leading-tight text-light khula-regular w-[732px] text-center leading-[85px]"
              style={{
                transform: isMobile
                  ? "none"
                  : useTransform(
            ...
            >
              Passionate Product & Graphic designer delivering impactful user experiences.
            </motion.p>
          </motion.div>
        </motion.div>
