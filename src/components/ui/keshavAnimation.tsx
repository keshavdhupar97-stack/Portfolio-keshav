...
type Props = React.ComponentProps<typeof motion.svg> & {
  speed?: number; // Control speed of the animation
...
function AppleHelloEnglishEffect({
  ...
  // Calculate adjusted durations based on the speed factor
  const calc = (x: number) => x * speed;
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        animate={animateProps}
        transition={{
          duration: calc(0.8), // Control duration based on speed
          ease: "easeInOut",
          opacity: { duration: 0.4 },
        }}
      />
      ...
      <motion.path
        ...
        transition={{
          duration: calc(2.8),
          ease: "easeInOut",
          delay: calc(0.7), // Control the delay for second path animation
          opacity: { duration: 0.7, delay: calc(0.7) }, // Delay opacity transition as well
        }}
        onAnimationComplete={onAnimationComplete}
      />
    </motion.svg>
