        ...
        >
          <div className="flex flex-col w-1/2">
            ...
            <motion.h2
              variants={fadeInUpVariants}
              custom={2}
              className="khula-light text-5xl text-nowrap flex flex-col gap-2"
            >
            Keshav Dhupar
              <p className="text-sm ps-1">Product & Graphic designer</p>
            </motion.h2>
          ...
          >
            <motion.p variants={fadeInUpVariants} custom={4} className="text-justify">
              I’m a Product & Graphic Designer, delivering innovative concepts with creativity and precision across diverse fields. Equipped with the latest design tools, software, and techniques, I create designs that connect with audiences—whether it’s for digital products, branding, or creative visuals.
              </motion.p>
